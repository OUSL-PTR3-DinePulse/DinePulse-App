  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen min-w-screen justify-center bg-[#FAFACC]">
      <div className='  gap-8 min-w-[35%] flex flex-col  md:min-w-[35%] justify-center px-6 md:px-0 py-8 md:py-0'>
        ...
        <div className='input'>
          <img src={user} />
          <input type="text" placeholder='Name' onChange={(e)=>setForm({...form,fullName:e.target.value})}  autoComplete="off"/>
        </div>
        <div className='input'>
          <img src={mail} />
          <input type="text" placeholder='Email' onChange={(e)=>setForm({...form,email:e.target.value})}  autoComplete="off"/>
        </div>
        <div className='input'>
          <img src={pass} />
